...
Event.create!([
  {
    ...
    location: 'Denver, CO',
    price: 0.00,
    event_start_date: Date.new(2021,3,23),
    event_end_date: Date.new(2021,3,23),
    description: %{
  ...
  },
  {
    ...
    location: 'Austin, TX',
    price: 15.00,
    event_start_date: Date.new(2022,12,11),
    event_end_date: Date.new(2022,12,12),
    description: %{
  ...
  },
  {
    ...
    location: 'Dallas, TX',
    price: 75.00,
    event_start_date: Date.new(2021,8,4),
    event_end_date: Date.new(2021,8,4),
    description: %{
  ...
  },
  {
    ...
    price: 0.00,
    event_start_date: Date.new(2021,10,8),
    event_end_date: Date.new(2021,10,9),
    description: %{
  ...
  },
  {
    ...
    location: 'Reston, VA',
    price: 0.00,
    event_start_date: Date.new(2021,5,1),
    event_end_date: Date.new(2021,5,1),
    description: %{
  ...
  },
  {
    ...
    location: 'Chigaco, IL',
    price: 0.00,
    event_start_date: Date.new(2021,7,17),
    event_end_date: Date.new(2021,7,18),
    description: %{
  ...
  },
  {
    ...
    price: 15.00,
    event_start_date: Date.new(2022,3,9),
    event_end_date: Date.new(2022,3,11),
    description: %{
  ...
  },
  {
    ...
    price: 0.00,
    event_start_date: Date.new(2022,2,3),
    event_end_date: Date.new(2022,2,5),
    description: %{
  ...
  },
  {
    ...
    price: 25.00,
    event_start_date: Date.new(2023,3,23),
    event_end_date: Date.new(2023,3,23),
    description: %{
